...
function oct2Bin(num) {
    ...
    if(excepHandler(octal, "oct")) {
        ...
        document.getElementById("conver").innerHTML="You entered a non octal number. Octal numbers only use 0 to 7.";
    };
}
...
function hex2Dec(num) {
    ...
    if(excepHandler(hexadecimal, "hex")){
        ...
        document.getElementById("conver").innerHTML="You entered a non hexadeimal number. Hex numbers only use 0 to 9 and A to F.";
    };
}
